    ...
    <?php if ($lang == "fr") { ?>
        ...
        <div class="project">
            <div class="project-info">
                <img class="pp" src="../../assets/img/php-logo.png" alt="Logo de PHP">
                <h1>
                    Template PHP
                </h1>
                ...
                <div class="descs">
                    <p class="description">
                        Ce <span style="color: #5865F2;">template</span> a été créé pour vous facilité la vie et aller plus vite à la<br>
                        création d'un projet, il vous suffit de suivre le "tutoriel" dans le <strong>README.md</strong> du github.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="social_link">
            <a target="_blank" href="https://github.com/Cut0x/template-site-php"><i class="bi bi-github"></i></a>
        </div>
    ...
    <?php } else { ?>
        ...
        <div class="project">
            <div class="project-info">
                ...
                <div class="descs">
                    <p class="description">
                        This <span style="color: #5865F2;">template</span> was created to make your life easier and go faster to the<br>
                        creation of a project, you just have to follow the "tutorial" in the <strong>README.md</strong> from github.
                    </p>
                </div>
            </div>
        </div>
